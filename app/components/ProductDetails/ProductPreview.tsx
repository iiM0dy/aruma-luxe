            ...
            <div className="relative group">
                ...
                <div className="absolute bottom-8 left-0 right-0 flex justify-center gap-12 text-primary">
                    <div className="flex flex-col items-center gap-2">
                        <span className="material-symbols-outlined cursor-default select-none text-3xl">verified</span>
                        <span className="text-[10px] uppercase tracking-widest text-white/60 font-noto">جودة فاخرة</span>
                    </div>
                    <div className="flex flex-col items-center gap-2">
                        <span className="material-symbols-outlined cursor-default select-none text-3xl">history</span>
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex text-primary">
                            <span className="material-symbols-outlined cursor-default select-none star-filled text-2xl"><svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24px" viewBox="0 0 24 24" width="24px" fill="#F4C025"><g><path d="M0 0h24v24H0V0z" fill="none" /><path d="M0 0h24v24H0V0z" fill="none" /></g><g><path d="M12 17.27 18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21 12 17.27z" /></g></svg></span>
                            <span className="material-symbols-outlined cursor-default select-none star-filled text-2xl"><svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24px" viewBox="0 0 24 24" width="24px" fill="#F4C025"><g><path d="M0 0h24v24H0V0z" fill="none" /><path d="M0 0h24v24H0V0z" fill="none" /></g><g><path d="M12 17.27 18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21 12 17.27z" /></g></svg></span>
                            <span className="material-symbols-outlined cursor-default select-none star-filled text-2xl"><svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24px" viewBox="0 0 24 24" width="24px" fill="#F4C025"><g><path d="M0 0h24v24H0V0z" fill="none" /><path d="M0 0h24v24H0V0z" fill="none" /></g><g><path d="M12 17.27 18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21 12 17.27z" /></g></svg></span>
                            <span className="material-symbols-outlined cursor-default select-none star-filled text-2xl"><svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24px" viewBox="0 0 24 24" width="24px" fill="#F4C025"><g><path d="M0 0h24v24H0V0z" fill="none" /><path d="M0 0h24v24H0V0z" fill="none" /></g><g><path d="M12 17.27 18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21 12 17.27z" /></g></svg></span>
                            <span className="material-symbols-outlined cursor-default select-none star-filled text-2xl"><svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24px" viewBox="0 0 24 24" width="24px" fill="#F4C025"><g><path d="M0 0h24v24H0V0z" fill="none" /><path d="M0 0h24v24H0V0z" fill="none" /></g><g><path d="M12 17.27 18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21 12 17.27z" /></g></svg></span>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 py-8 border-y border-white/5">
                    <div className="space-y-3">
                        <div className="flex items-center gap-2 text-primary">
                            <span className="material-symbols-outlined cursor-default select-none">expand_less</span>
                    ...
                    <div className="space-y-3">
                        <div className="flex items-center gap-2 text-primary">
                            <span className="material-symbols-outlined cursor-default select-none">favorite</span>
                    ...
                    <div className="space-y-3">
                        <div className="flex items-center gap-2 text-primary">
                            <span className="material-symbols-outlined cursor-default select-none">expand_more</span>
